...
Хочется уметь складывать векторы покомпоненто. А также брать `[]` от суммы. Иногда нужно подсчитать `i` элемент суммы, не считая всю сумму. Ленивое вычисление засчет шаблонов.
